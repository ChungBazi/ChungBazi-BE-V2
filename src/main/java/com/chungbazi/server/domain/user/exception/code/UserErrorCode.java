...
public enum UserErrorCode implements BaseErrorCode {
    ...
    INVALID_USER_NAME(HttpStatus.BAD_REQUEST, "USER4001", "사용자 이름을 입력해주세요."),
    INVALID_BIRTH(HttpStatus.BAD_REQUEST, "USER4002", "생년월일을 선택해주세요."),
    INVALID_SIDO_CODE(HttpStatus.BAD_REQUEST, "USER4003", "시/도를 선택해주세요."),
    INVALID_SIGUNGU_CODE(HttpStatus.BAD_REQUEST, "USER4004", "시/군/구를 선택해주세요."),
    INVALID_EDUCATION_CODE(HttpStatus.BAD_REQUEST, "USER4005", "학력을 선택해주세요."),
    INVALID_EMPLOYMENT_CODE(HttpStatus.BAD_REQUEST, "USER4006", "취업 상태를 선택해주세요."),
